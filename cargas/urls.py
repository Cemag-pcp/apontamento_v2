...
urlpatterns = [
    ...
    path('api/liberacoes/historico-datas/', views.datas_historico_liberacoes, name="datas_historico_liberacoes"),
    path('api/liberacoes/historico/', views.historico_liberacoes_dia, name="historico_liberacoes_dia"),
