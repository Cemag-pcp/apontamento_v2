...
from cargas.utils import (
    consultar_carretas, consultar_carretas_detalhado, gerar_sequenciamento, gerar_arquivos,
    criar_array_datas, get_base_carreta, normalizar_codigo_recurso_serie,
    consolidar_ordens_planejamento, _construir_ordens_planejamento_from_items,
)
