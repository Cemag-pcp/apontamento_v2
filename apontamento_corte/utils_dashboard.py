...
def hora_operacao_maquina(maquina_param, data_inicio, data_fim):
    ...
    sql = """
        ...
        registros AS (
            ...
            WHERE co2.grupo_maquina in ('laser_1','laser_2','laser_3','plasma')
...
def ordem_por_maquina(data_inicio, data_fim):
    ...
    sql = """
        ...
        WHERE 
            co.grupo_maquina in ('laser_1','laser_2','laser_3','plasma')
...
def producao_por_maquina(data_inicio, data_fim):
    ...
    sql = """
        ...
        FROM apontamento_v2.apontamento_corte_pecasordem asp 
