...
urlpatterns = [
    ...
    path('api/itens-disponiveis-cambao/', views.itens_disponiveis_cambao, name='itens_disponiveis_cambao'),
    path('api/editar-cambao/', views.editar_cambao, name='editar_cambao'),
