document.addEventListener('DOMContentLoaded', () => {
    const app = document.getElementById('pecas-corte-app');
    if (!app) return;
    ...
    const tbody = document.getElementById('pecas-corte-body');
    const summaryEl = document.getElementById('pagination-summary-corte');
    const totalIndicator = document.getElementById('total-indicator-corte');
    const pageSizeSelect = document.getElementById('page-size-corte');
    const prevBtn = document.getElementById('prev-page-corte');
    const nextBtn = document.getElementById('next-page-corte');
    const refreshBtn = document.getElementById('refresh-pecas-btn');
    const ordemInput = document.getElementById('f-ordem-corte');
    const pecaInput = document.getElementById('f-peca');
    const applyFiltersBtn = document.getElementById('apply-filters-corte');
    const clearFiltersBtn = document.getElementById('clear-filters-corte');
    ...
    function buildRow(item) {
        ...
        tr.appendChild(textCell(item.peca ?? '-'));
