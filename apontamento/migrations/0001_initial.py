    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="apontamento_operador",
                        to="cadastro.operador",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="interrupcoes",
                        to="apontamento.apontamento",
                    ),
                ),
                (
                    "motivo",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="planejamento_maquina",
                        to="cadastro.maquina",
                    ),
                ),
                (
                    "peca_processo_maquina",
                    models.ForeignKey(
                        blank=True,
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="cadastro.pecamaquina",
                    ),
                ),
                (
                    "processo",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="apontamento_planejamento",
                to="apontamento.planejamento",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="planejamento_peca",
                        to="cadastro.pecas",
                    ),
                ),
                (
