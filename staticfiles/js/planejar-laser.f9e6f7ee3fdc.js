...
document.getElementById('fileUploadLaser3').addEventListener('change', async (event) => {
    const fileInput = event.target;
    ...
    const form = document.getElementById('laser3Form');
    ...
    formData.append('tipoMaquina', 'laser_3');
    ...
    try {
        ...
        if (response.ok) {
            const data = await response.json();
            const table = document.getElementById('previewTableLaser3');
            const tbody = table.querySelector('tbody');
            tbody.innerHTML = '';
            ...
            // Mostrar a tabela e botão de confirmação
            table.style.display = 'block';
            document.getElementById('confirmButtonLaser3').style.display = 'inline-block';
            document.getElementById('previewTableLaser3').style.display = 'block';
...
document.getElementById('confirmButtonLaser3').addEventListener('click', async (event) => {
    ...
    const fileInput = document.getElementById('fileUploadLaser3');
    const descricaoInput = document.getElementById('descricaoLaser3');
    const tipoChapaInput = document.getElementById('tipoChapaLaser3');
    const retalhoCheckbox = document.getElementById('retalhoLaser3');
    const dataProgramacao = document.getElementById('dataProgramacaoLaser3').value;
    ...
    formData.append('descricao', descricaoInput.value)
    formData.append('tipo_chapa', tipoChapaInput.value)
    formData.append('maquina', 'laser_3')
    formData.append('retalho', retalhoCheckbox.checked)
    formData.append('dataProgramacao', dataProgramacao)
    ...
    if (response.ok) {
        ...
        document.getElementById('confirmButtonLaser3').style.display = 'none';
        document.getElementById('previewTableLaser3').style.display = 'none';
        document.getElementById("laser3Form").reset();
...
document.getElementById('resetFileLaser3').addEventListener('click', () => {
    // Reseta o campo de upload de arquivo
    const fileInput = document.getElementById('fileUploadLaser3');
    fileInput.value = '';
