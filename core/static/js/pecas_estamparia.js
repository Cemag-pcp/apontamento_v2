document.addEventListener('DOMContentLoaded', () => {
    const app = document.getElementById('pecas-estamparia-app');
    if (!app) return;
    ...
    const tbody = document.getElementById('pecas-estamparia-body');
    const summaryEl = document.getElementById('pagination-summary-estamparia');
    const totalIndicator = document.getElementById('total-indicator-estamparia');
    const pageSizeSelect = document.getElementById('page-size-estamparia');
    const prevBtn = document.getElementById('prev-page-estamparia');
    const nextBtn = document.getElementById('next-page-estamparia');
    const refreshBtn = document.getElementById('refresh-pecas-estamparia-btn');
    const ordemInput = document.getElementById('f-ordem-estamparia');
    const pecaInput = document.getElementById('f-peca-estamparia');
    const applyFiltersBtn = document.getElementById('apply-filters-estamparia');
    const clearFiltersBtn = document.getElementById('clear-filters-estamparia');
