...
urlpatterns = [
    ...
    path('api/pacotes/deletar/<int:id>/', views.deletar_pacote, name='deletar_pacote'),
    path('api/pacotes/itens/<int:item_id>/deletar/', views.deletar_item_pacote, name='deletar_item_pacote'),
    path('api/pacotes/itens/<int:item_id>/atualizar-quantidade/', views.atualizar_quantidade_item, name='atualizar_quantidade_item'),
