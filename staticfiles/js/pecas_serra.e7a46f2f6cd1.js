document.addEventListener('DOMContentLoaded', () => {
    const app = document.getElementById('pecas-serra-app');
    if (!app) return;
    ...
    const tbody = document.getElementById('pecas-serra-body');
    const summaryEl = document.getElementById('pagination-summary-serra');
    const totalIndicator = document.getElementById('total-indicator-serra');
    const pageSizeSelect = document.getElementById('page-size-serra');
    const prevBtn = document.getElementById('prev-page-serra');
    const nextBtn = document.getElementById('next-page-serra');
    const refreshBtn = document.getElementById('refresh-pecas-serra-btn');
    const ordemInput = document.getElementById('f-ordem-serra');
    const pecaInput = document.getElementById('f-peca-serra');
    const applyFiltersBtn = document.getElementById('apply-filters-serra');
    const clearFiltersBtn = document.getElementById('clear-filters-serra');
